...
Alerting Module
-----------------
Flags identities that need urgent attention.
Right now this just prints a formatted alert to the console and
writes to a log file. Later you could extend this to send an
email (smtplib) or post to a Slack webhook.
"""
